    ...
    public class DataContext : IdentityDbContext<AppUser, AppRole, int, AppUserClaim, AppUserRole, AppUserLogin, AppRoleClaim, AppUserToken> //DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Building>().HasData(
                ...
                new Building { Id = 2, Name = "2-ci korpus" },
                new Building { Id = 3, Name = "3-cü korpus" },
                new Building { Id = 4, Name = "4-cü korpus" },
                new Building { Id = 5, Name = "5-ci korpus" },
                new Building { Id = 6, Name = "6-cı korpus" },
                new Building { Id = 7, Name = "7-ci korpus" }
            );
        }
