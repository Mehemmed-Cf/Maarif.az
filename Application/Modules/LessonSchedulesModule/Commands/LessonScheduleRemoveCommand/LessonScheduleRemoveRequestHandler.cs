...
{
    public class LessonScheduleRemoveRequestHandler : IRequestHandler<LessonScheduleRemoveRequest>
    {
        ...
        public async Task Handle(LessonScheduleRemoveRequest request, CancellationToken cancellationToken)
        {
